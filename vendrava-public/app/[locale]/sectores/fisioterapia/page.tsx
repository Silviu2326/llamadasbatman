...
const INDUSTRY_ID = "physiotherapy";
const ROUTE_KEY = "industry.physiotherapy";
...
export async function generateMetadata(): Promise<Metadata> {
  const data = getData();
  if (!data) return {};
  return buildMetadata({ routeKey: ROUTE_KEY, locale: EXPECTED_LOCALE, title: data.content.metaTitle, description: data.content.metaDescription });
}
