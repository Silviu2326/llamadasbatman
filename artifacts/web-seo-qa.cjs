...
let jobStatus='succeeded', auditPosts=0, proposalPosts=0;
...
else if(path==='/api/web-connections') body=[connection];
...
console.log(JSON.stringify({errors,auditPosts,proposalPosts,overflow,url:page.url()}));
await browser.close();
