...
export const messages = {
  es: {
    ...
    nav: {
      ...
      landings: 'Web y SEO',
      funnels: 'Funnels',
      organicLeads: 'Orgánico y social',
      inbox: 'Inbox',
      calls: 'Llamadas',
      agents: 'Agentes IA',
      playbooks: 'Playbooks',
  ...
  en: {
    ...
    nav: {
      dashboard: 'Dashboard', objectives: 'Objectives', acquisition: 'Acquisition', conversation: 'Conversation', nurturing: 'Nurturing', growth: 'Growth', sales: 'Sales', system: 'System', campaigns: 'Campaigns', ads: 'Ads', prospectFinder: 'Prospect Finder', landings: 'Web & SEO', funnels: 'Funnels', organicLeads: 'Organic & social', inbox: 'Inbox', calls: 'Calls', agents: 'AI Agents', playbooks: 'Playbooks', voiceTest: 'Voice Test', emailMarketing: 'Email marketing', automations: 'Automations', growthHub: 'Growth Hub', leads: 'Leads', pipeline: 'Pipeline', meetings: 'Meetings', revenueIntelligence: 'Revenue intelligence', insights: 'Insights', knowledgeBase: 'Knowledge Base', settings: 'Settings', governance: 'Enterprise governance', accessControl: 'Access control', adRecipes: 'Ad recipes',
    },
    sidebar: {
