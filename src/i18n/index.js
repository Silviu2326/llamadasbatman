...
export const LOCALE_STORAGE_KEY = 'vozia:locale:v1'
...
const messages = {
  es: {
    ...
    onboarding: {
      ...
      profileTitle: '¿Cómo vas a usar VozIA?',
  ...
  en: {
    common: {
      appName: 'VozIA', create: 'Create', from: 'From', until: 'Until', comingSoon: 'coming soon', save: 'Save changes', saving: 'Saving…', cancel: 'Cancel', close: 'Close', retry: 'Retry', reload: 'Reload application', search: 'Search', loading: 'Loading…', language: 'Language', spanish: 'Español', english: 'English', enabled: 'Enabled', disabled: 'Disabled', connected: 'Connected', notConnected: 'Not connected', unavailable: 'Unavailable', realData: 'Live data', demoMode: 'Demo mode', noResults: 'No results', all: 'All', today: 'Today', next: 'Next', previous: 'Previous',
    },
    nav: {
      dashboard: 'Dashboard', objectives: 'Objectives', acquisition: 'Acquisition', conversation: 'Conversation', nurturing: 'Nurturing', growth: 'Growth', sales: 'Sales', system: 'System', campaigns: 'Campaigns', ads: 'Ads', social: 'Social media', prospectFinder: 'Prospect Finder', landings: 'Landings & websites', funnels: 'Funnels', organicLeads: 'Organic Leads', inbox: 'Inbox', calls: 'Calls', agents: 'AI Agents', playbooks: 'Playbooks', voiceTest: 'Voice Test', emailMarketing: 'Email marketing', automations: 'Automations', growthHub: 'Growth Hub', leads: 'Leads', pipeline: 'Pipeline', meetings: 'Meetings', revenueIntelligence: 'Revenue intelligence', insights: 'Insights', knowledgeBase: 'Knowledge Base', settings: 'Settings', governance: 'Enterprise governance', accessControl: 'Access control', adRecipes: 'Ad recipes',
    },
    sidebar: {
    ...
    auth: {
      protectedAccess: 'Protected access', encryptedData: 'Encrypted data', available247: 'AI available 24/7', conversationalIntelligence: 'Conversational intelligence', activeConversation: 'Active conversation', confirmedMeeting: 'Meeting confirmed', listening: 'Listening · 00:42', meetingToday: 'Meeting · today 16:30', active: 'VozIA is active', commercialTeam: 'Your sales team', autopilot: 'On autopilot.', agentsDescription: 'Voice agents that call, qualify and book meetings for you, without pauses.', designedForTeams: 'Built for teams that want to grow', simpleHumanScalable: 'Simple. Human. Scalable.', welcomeBack: 'Welcome back.', accessPlatform: 'Access your conversational AI platform', workspaceProtected: 'Your workspace is protected', email: 'Email address', password: 'Password', passwordPlaceholder: 'Your password', hidePassword: 'Hide password', showPassword: 'Show password', forgotPassword: 'Forgot password?', recoveryTitle: 'Recover access with support', recoveryDescription: 'No email will be sent from this screen. Enter your account and open a message so support can validate the request.', accountEmail: 'Account email', openSupportEmail: 'Open support email', signIn: 'Sign in', signingIn: 'Signing in…', missingCredentials: 'Enter your email and password to continue.', invalidCredentials: 'The email or password is incorrect.', signInError: 'We could not sign you in. Please try again.',
    },
    ...
    status: { live: 'Live data', demo: 'Explicit demo mode', empty: 'No data yet', disconnected: 'Integration disconnected', error: 'Connection error', loading: 'Loading data', retry: 'Retry', configure: 'Configure' },
    calls: { title: 'Calls', subtitle: 'Listen, understand and convert every conversation.', commands: 'Commands', refresh: 'Refresh', filters: 'Filters', export: 'Export', newCall: 'New call', intelligence: 'VozIA intelligence', heroTitle: 'Every conversation', heroAccent: 'is an opportunity.', heroDescription: 'VozIA AI analyzes your calls, detects key signals and helps you make better decisions to close more deals.', recentCalls: 'View recent calls', copilot: 'Open copilot', summary: 'Call summary', totalCalls: 'Total calls', averageDuration: 'Average duration', conversionRate: 'Conversion rate', meetingsBooked: 'Meetings booked', recent: 'Recent calls', conversationsInView: '{{count}} conversations in this view', customizeView: 'Customize view', searchPlaceholder: 'Search contact, company or role…', contact: 'Contact', company: 'Company', date: 'Date', outcome: 'Outcome', selectAll: 'Select all visible calls', noCalls: 'No calls yet', noMatches: 'No calls found', startCall: 'Start a call to record the first conversation.', tryAnother: 'Try another contact, company or outcome.', todayPerformance: 'Today’s performance', syncedMetrics: 'Metrics synced', noMetrics: 'No metrics available', liveMetrics: 'Live metrics available.', noPerformanceData: 'No performance data yet',
    },
