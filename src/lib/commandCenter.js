...
export const COMMAND_SHORTCUTS = [
  ...
  { id: 'open-marketplace', label: 'Abrir marketplace', labelEn: 'Open marketplace', defaultKey: 'MOD+ALT+K', action: 'navigate', path: '/marketplace', permissionPath: '/marketplace' },
  { id: 'open-connections', label: 'Abrir conexiones', labelEn: 'Open connections', defaultKey: 'MOD+ALT+O', action: 'navigate', path: '/conexiones', permissionPath: '/conexiones' },
