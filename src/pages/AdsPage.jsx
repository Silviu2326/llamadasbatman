...
export default function AdsPage() {
  ...
  async function manageCampaign(action) {
    ...
    try {
      ...
      const labels = { publish: 'borrador enviado a Meta', activate: 'campaÃ±a activada', pause: 'campaÃ±a pausada' }
      showNotice(`La ${labels[action]}.`)
      await loadOverview()
    } catch {
      showNotice('Meta no pudo completar la operaciÃ³n. Revisa la cuenta y vuelve a intentarlo.')
    } finally {
