...
export default function LeadDetailPage() {
  ...
  useEffect(() => {
    ...
    ]).then(([timelineResult, auditResult, notesResult, filesResult, statsResult, activitiesResult, consentResult, ownersResult, emailHistoryResult, preferencesResult, leadResult]) => {
      if (!active) return
